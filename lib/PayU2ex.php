...
class PayU
{
    public static $LU_URL = 'https://sandbox.payu.ru/order/lu.php';
    public static $TOKEN_PAYMENT_URL = 'https://sandbox.payu.ru/order/tokens/';
    public static $IDN_URL = 'https://sandbox.payu.ru/order/idn.php';
    public static $IRN_URL = 'https://sandbox.payu.ru/order/irn.php';
    public static $PAYOUT_LINK_CARD_URL = 'https://sandbox.payu.ru/order/pwa/service.php/UTF/NewPayoutCard';
    public static $PAYOUT_URL = 'https://sandbox.payu.ru/order/prepaid/NewCardPayout';
    public static $IOS_URL = 'https://sandbox.payu.ru/order/ios.php';
     ...
     * @param bool $debug
     */
    function __construct($merchantId, $merchantName, $secretKey, $prod, $debug = false)
    {
        ...
        if ($prod === "prod")
        {
            PayU::$LU_URL = 'https://secure.payu.ru/order/lu.php';
            PayU::$TOKEN_PAYMENT_URL = 'https://secure.payu.ru/order/tokens/';
            PayU::$IDN_URL = 'https://secure.payu.ru/order/idn.php';
            PayU::$IRN_URL = 'https://secure.payu.ru/order/irn.php';
            PayU::$PAYOUT_LINK_CARD_URL = 'https://secure.payu.ru/order/pwa/service.php/UTF/NewPayoutCard';
            PayU::$PAYOUT_URL = 'https://secure.payu.ru/order/prepaid/NewCardPayout';
            PayU::$IOS_URL = 'https://secure.payu.ru/order/ios.php';
        }
    }
    ...
    {
        $data['merchantCode'] = $this->merchantName;
        $data['payin'] = '1';
        $data['token'] = $token;
